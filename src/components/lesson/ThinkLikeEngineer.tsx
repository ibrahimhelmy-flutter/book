...
import { Wrench, CheckCircle, HelpCircle, ChevronLeft, Award } from "lucide-react";
...
export function ThinkLikeEngineer({ challenge }: Props) {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-2xl p-6 text-white shadow-xl my-8">
      ...
      {/* Engineering Hint */}
      {challenge.hint && (
        <div className="p-4 bg-amber-950/20 border border-amber-500/30 rounded-xl text-xs flex gap-2.5 items-start text-amber-200">

  ...
  const getTeacherNotes = () => {
    switch (slideType) {
      ...
      case "callout":
        return {
          time: "3-5 دقائق",
          goal: "تفعيل التفكير النقدي والعصف الذهني والمناقشة الصفية الموجهة.",
          points: [
            "اطرح سؤال التوقف والتفكير على الفصل وأعطِ الطلاب دقيقة للتفكير الفردي أو الثنائي.",
            "ناقش مع الطلاب المخاطر المحتملة (مثل خطر الهلوسة في التقارير المدرسية والأبحاث).",
            "استمع لإجابتين أو ثلاث إجابات ولخّص القاعدة المعتمدة للتحقق من المخرجات.",
          ],
          prompt: "سؤال مناقشة: 'لماذا قد تبدو إجابة الذكاء الاصطناعي مقنعة جدًا حتى لو كانت غير صحيحة بالكامل؟'",
        };
      case "applied_task":
        return {
          time: "4-6 دقائق",
          goal: "ربط المفاهيم النظرية بتحديات وسيناريوهات واقعية وميدانية.",
          points: [
            "اقرأ السيناريو الواقعي للطلاب وحدد المتغيرات الأساسية والمؤثرات الميدانية.",
            "ناقش العوامل التي قد تجعل النموذج يخطئ في تشخيص البيانات الجديدة.",
            "استعرض الحل والتحليل النموذجي وقارنه مع توقعات الطلاب.",
          ],
          prompt: "تحدي تطبيقي: 'ما هي البيانات الإضافية التي يحتاجها النظام ليتفادى هذا الخطأ الميداني؟'",
        };
      case "example":
        return {
          time: "5 دقائق",
